...
#
################################################################################
THUNDER_PLUGINS_VERSION = R5.1.0
...
THUNDER_PLUGINS_CONF_OPTS += -DENABLE_ATOMIC=ON

ifneq ($(BR2_PACKAGE_THUNDER_COMPOSITOR_COMPOSITOR_RENDER_NODE),"")
THUNDER_PLUGINS_CONF_OPTS += -DPLUGIN_COMPOSITOR_RENDER_NODE='$(call qstrip,$(BR2_PACKAGE_THUNDER_COMPOSITOR_COMPOSITOR_RENDER_NODE))'
endif
