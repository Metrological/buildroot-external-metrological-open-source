...
#
################################################################################
THUNDER_PLUGINS_VERSION = e460325249bd67fe38910de4c1f2517c3b38d2cd
...
THUNDER_PLUGINS_CONF_OPTS += -DPLUGIN_COMPOSITOR_RESOLUTION=1080p
else ifeq ($(BR2_PACKAGE_THUNDER_COMPOSITOR_RESOLUTION_2160P),y)
THUNDER_PLUGINS_CONF_OPTS += -DPLUGIN_COMPOSITOR_RESOLUTION=2160p
endif
...
ifeq ($(BR2_PACKAGE_THUNDER_PLUGININITIALIZERSERVICE),y)
THUNDER_PLUGINS_CONF_OPTS += -DPLUGIN_PLUGININITIALIZERSERVICE=ON
endif
