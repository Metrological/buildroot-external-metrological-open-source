...
#
################################################################################
THUNDER_PLUGINS_VERSION = a595492b13c40c25cd5c98fb5a8a562f3c5604f5
...
THUNDER_PLUGINS_CONF_OPTS += -DTHUNDER_PLUGIN_COBALT_STARBOARD_CONFIGURATION_INCLUDE="third_party/starboard/wpe/shared/configuration_public.h"
endif
...
THUNDER_PLUGINS_CONF_OPTS += -DPLUGIN_BLUETOOTH_FIRMWARE_DIRECTORY="$(call qstrip,$(BR2_PACKAGE_THUNDER_BLUETOOTH_FIRMWARE))"
endif
...
THUNDER_PLUGINS_CONF_OPTS += -DPLUGIN_COMPOSITOR_IMPLEMENTATION=Mesa
THUNDER_PLUGINS_DEPENDENCIES += mesa3d
else ifeq ($(BR2_PACKAGE_WAYLAND),y)
THUNDER_PLUGINS_CONF_OPTS += -DPLUGIN_COMPOSITOR_IMPLEMENTATION=Wayland
THUNDER_PLUGINS_DEPENDENCIES += wayland
endif
THUNDER_PLUGINS_CONF_OPTS += -DCOMPOSITOR_DISPLAY_IMPLEMENTATION=DRM
THUNDER_PLUGINS_CONF_OPTS += -DCOMPOSITOR_BACKEND_IMPLEMENTATION=DRM
THUNDER_PLUGINS_CONF_OPTS += -DPLUGIN_COMPOSITOR_CLIENTBRIDGE="buffer|0770"
