...
ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_CLIENTLIBRARY_GSTREAMERCLIENT),y)
...
ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_CLIENTLIBRARY_DISPLAYINFO_IMPLEMENTATION_NEXUS),y)
WPEFRAMEWORK_CLIENTLIBRARIES_CONF_OPTS += -DCRYPTOGRAPHY_IMPLEMENTATION=Nexus -DOPENSSL_PLATFORM_VAULT=ON
ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_CLIENTLIBRARY_DISPLAYINFO_IMPLEMENTATION_NEXUS_COMMAND_BASED),y)
...
else ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_CLIENTLIBRARY_DISPLAYINFO_IMPLEMENTATION_OPENSSL),y)
WPEFRAMEWORK_CLIENTLIBRARIES_CONF_OPTS += -DCRYPTOGRAPHY_IMPLEMENTATION=OpenSSL
else ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_CLIENTLIBRARY_DISPLAYINFO_IMPLEMENTATION_THUNDER),y)
