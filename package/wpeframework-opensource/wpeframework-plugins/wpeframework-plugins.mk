...
#
################################################################################
WPEFRAMEWORK_PLUGINS_VERSION = a595492b13c40c25cd5c98fb5a8a562f3c5604f5
...
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_DIALSERVER_INTERFACE),"")
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_DIALSERVER_INTERFACE="$(call qstrip,$(BR2_PACKAGE_WPEFRAMEWORK_DIALSERVER_INTERFACE))"
endif
...
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_BLUETOOTH_DEVICE),)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_BLUETOOTH_PORT="$(call qstrip,$(BR2_PACKAGE_WPEFRAMEWORK_BLUETOOTH_DEVICE))"
endif
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_BLUETOOTH_FIRMWARE_DIRECTORY),)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_BLUETOOTH_FIRMWARE_DIRECTORY="$(call qstrip,$(BR2_PACKAGE_WPEFRAMEWORK_BLUETOOTH_FIRMWARE))"
endif
...
WPEFRAMEWORK_PLUGINS_DEPENDENCIES += wpeframework-clientlibraries
...
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_COMPOSITOR_IMPLEMENTATION=Mesa
WPEFRAMEWORK_PLUGINS_DEPENDENCIES += mesa3d
else ifeq ($(BR2_PACKAGE_WAYLAND),y)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_COMPOSITOR_IMPLEMENTATION=Wayland
WPEFRAMEWORK_PLUGINS_DEPENDENCIES += wayland
endif
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DCOMPOSITOR_DISPLAY_IMPLEMENTATION=DRM
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DCOMPOSITOR_BACKEND_IMPLEMENTATION=DRM
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_COMPOSITOR_CLIENTBRIDGE="buffer|0770"
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_COMPOSITOR_OUTOFPROCESS=true
ifeq ($(BR2_PACKAGE_HAS_LIBGBM),y)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DCOMPOSITOR_BUFFER_IMPLEMENTATION=GBM
else 
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DCOMPOSITOR_BUFFER_IMPLEMENTATION=DRMDumb
endif
WPEFRAMEWORK_PLUGINS_DEPENDENCIES += libdrm wpeframework-libraries
else ifeq ($(BR2_PACKAGE_WESTEROS),y)
...
WPEFRAMEWORK_PLUGINS_DEPENDENCIES += rpi-userland
else
