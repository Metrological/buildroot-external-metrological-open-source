...
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_COMPOSITOR_CLIENTBRIDGE=buffer
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_COMPOSITOR_CONNECTOR=display
...
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DCOMPOSITOR_BUFFER_IMPLEMENTATION=Stub
endif
WPEFRAMEWORK_PLUGINS_DEPENDENCIES += libdrm mesa3d wpeframework-libraries wpeframework-clientlibraries
else
