...
#
################################################################################
WPEFRAMEWORK_RDKSERVICES_VERSION = eb54220754a3267ebd940fd17cc3735a634d410c
...
WPEFRAMEWORK_CDMI_PERMISSION=$(subst ",,$(BR2_PACKAGE_WPEFRAMEWORK_DATA_PATH)")/OCDM d 0550 root $(subst ",,$(BR2_PACKAGE_WPEFRAMEWORK_CDMI_GROUP)") - - - - -
endif
...
WPEFRAMEWORK_RDKSERVICES_DEPENDENCIES += wpewebkit-ml
...
WPEFRAMEWORK_WEBKITBROWSER_PERMISSION=$(subst ",,$(BR2_PACKAGE_WPEFRAMEWORK_DATA_PATH)")/WebKitBrowser r 0440 root $(subst ",,$(WPEFRAMEWORK_WEBKITBROWSER_USER_GROUP)") - - - - -
endif
