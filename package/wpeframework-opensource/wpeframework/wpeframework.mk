...
#
################################################################################
WPEFRAMEWORK_VERSION = e44638fbd40c9240d551cc279492c36afbd4d8c4
...
ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_TRACE_LEVEL_OFF),y)
	WPEFRAMEWORK_CONF_OPTS += -DDISABLE_TRACING=ON
else ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_TRACE_LEVEL_1),y)
	WPEFRAMEWORK_CONF_OPTS += -DDISABLE_TRACING=OFF -DENABLED_TRACING_LEVEL=1
else ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_TRACE_LEVEL_2),y)
	WPEFRAMEWORK_CONF_OPTS += -DDISABLE_TRACING=OFF -DENABLED_TRACING_LEVEL=2
else ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_TRACE_LEVEL_3),y)
	WPEFRAMEWORK_CONF_OPTS += -DDISABLE_TRACING=OFF -DENABLED_TRACING_LEVEL=3
else ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_TRACE_LEVEL_4),y)
	WPEFRAMEWORK_CONF_OPTS += -DDISABLE_TRACING=OFF -DENABLED_TRACING_LEVEL=4
else ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_TRACE_LEVEL_5),y)
	WPEFRAMEWORK_CONF_OPTS += -DDISABLE_TRACING=OFF -DENABLED_TRACING_LEVEL=5
endif

ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_TRACING_MODULES),)
WPEFRAMEWORK_CONF_OPTS += -DENABLE_TRACING_MODULES=$(BR2_PACKAGE_WPEFRAMEWORK_TRACING_MODULES)
endif
