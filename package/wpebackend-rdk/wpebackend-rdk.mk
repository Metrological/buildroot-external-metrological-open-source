...
ifeq ($(BR2_PACKAGE_THUNDER_COMPOSITORCLIENT), y)
    WPEBACKEND_RDK_DEPENDENCIES += thunder
    ...
    ifeq ($(BR2_PACKAGE_RPI_USERLAND),y)
        ifeq ($(BR2_PACKAGE_WAYLAND)$(BR2_PACKAGE_WESTEROS)$(BR2_PACKAGE_THUNDER_COMPOSITORCLIENT),yyy)
            WPEBACKEND_RDK_DEPENDENCIES += libegl wayland westeros thunder-plugins
        ...
        else ifeq ($(BR2_PACKAGE_THUNDER_COMPOSITORCLIENT),y)
            WPEBACKEND_RDK_DEPENDENCIES += libegl thunder-plugins
            WPEBACKEND_RDK_FLAGS +=-DUSE_BACKEND_WPEFRAMEWORK=ON -DUSE_HOLE_PUNCH_GSTREAMER=OFF -DUSE_INPUT_LIBINPUT=OFF
        else
    ...
    # USE_BACKEND_BCM_NEXUS_WAYLAND or USE_BACKEND_BCM_NEXUS
        ...
        else ifeq ($(BR2_PACKAGE_WAYLAND)$(BR2_PACKAGE_WESTEROS)$(BR2_PACKAGE_THUNDER_COMPOSITORCLIENT),yyn)
        	WPEBACKEND_RDK_DEPENDENCIES += wayland westeros
        	WPEBACKEND_RDK_FLAGS +=-DUSE_BACKEND_WESTEROS=ON -DUSE_HOLE_PUNCH_GSTREAMER=OFF -DUSE_WESTEROS_SINK=OFF
        else ifeq ($(BR2_PACKAGE_THUNDER_COMPOSITORCLIENT),y)
            WPEBACKEND_RDK_DEPENDENCIES += thunder thunder-plugins
...
endif #BR2_PACKAGE_THUNDER_COMPOSITORCLIENT
