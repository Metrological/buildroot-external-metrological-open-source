...
WPEWEBKIT_ML_VERSION = c2bbe41520037aa883e6cab9fc40524f6e2e4cd0
endif

ifeq ($(BR2_PACKAGE_WPEWEBKIT_ML2_28),y)  
WPEWEBKIT_ML_VERSION_VALUE = 2.28
WPEWEBKIT_ML_VERSION = a8cb57195b377b58b8f5ef13d8c60f9b36ed2c7e
endif

ifeq ($(BR2_PACKAGE_WPEWEBKIT_ML2_38),y)  
WPEWEBKIT_ML_VERSION_VALUE = 2.38
WPEWEBKIT_ML_VERSION = 3add6870bd5cd4293af74a25219dfb2fcaca93df
endif
...
ifneq ($(BR2_PACKAGE_WPEWEBKIT_ML_PARALLEL_BUILD_JOBS),"0")
WPEWEBKIT_ML_NINJA_OPTS += -j$(call qstrip,$(BR2_PACKAGE_WPEWEBKIT_ML_PARALLEL_BUILD_JOBS))
endif
